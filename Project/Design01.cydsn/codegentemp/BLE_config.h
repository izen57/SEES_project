...
#define CY_BLE_ADV_PKT_0_INDEX_URI   (0x12u)
 ...
 */
#define CY_BLE_DEVICE_INTERFACE_SERVICE_INDEX   (0x00u) /* Index of Device_Interface service in the cy_ble_customs array */
#define CY_BLE_DEVICE_INTERFACE_GREEN_LED_TOGGLE_CHAR_INDEX   (0x00u) /* Index of GREEN_LED_TOGGLE characteristic */
#define CY_BLE_DEVICE_INTERFACE_RED_LED_TOGGLE_CHAR_INDEX   (0x01u) /* Index of RED_LED_TOGGLE characteristic */


#define CY_BLE_DEVICE_INTERFACE_SERVICE_HANDLE   (0x0010u) /* Handle of Device_Interface service */
#define CY_BLE_DEVICE_INTERFACE_GREEN_LED_TOGGLE_DECL_HANDLE   (0x0011u) /* Handle of GREEN_LED_TOGGLE characteristic declaration */
#define CY_BLE_DEVICE_INTERFACE_GREEN_LED_TOGGLE_CHAR_HANDLE   (0x0012u) /* Handle of GREEN_LED_TOGGLE characteristic */
#define CY_BLE_DEVICE_INTERFACE_RED_LED_TOGGLE_DECL_HANDLE   (0x0013u) /* Handle of RED_LED_TOGGLE characteristic declaration */
#define CY_BLE_DEVICE_INTERFACE_RED_LED_TOGGLE_CHAR_HANDLE   (0x0014u) /* Handle of RED_LED_TOGGLE characteristic */
