...
static const cy_stc_ble_customs_t cy_ble_customs[0x01u] = {
    ...
    /* Device_Interface service */
    {
        0x0010u, /* Handle of the Device_Interface service */ 
        {

            /* GREEN_LED_TOGGLE characteristic */
            {
                0x0012u, /* Handle of the GREEN_LED_TOGGLE characteristic */ 
            ...
            {
                0x0014u, /* Handle of the RED_LED_TOGGLE characteristic */ 
