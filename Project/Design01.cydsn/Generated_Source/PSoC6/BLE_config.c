...
cy_stc_ble_gapp_disc_data_t cy_ble_discoveryData[0x01u] = {
    ...
    /* Peripheral configuration 0 */
    {
        ...
        0x45u, 0x20u, 0x47u, 0x61u, 0x74u, 0x65u, 0x77u,
        0x61u, 0x79u, 0x20u, 0x31u, 0x0Au, 0x24u, 0x01u,
        0x2Fu, 0x67u, 0x61u, 0x74u, 0x65u, 0x77u, 0x61u,
        0x79u, 0x00u, 0x00u }, /* uint8_t advertising_data[CY_BLE_MAX_ADV_DATA_LEN] */ 
...
static uint8_t cy_ble_attValues[0x1Fu] = {
    /* Device Name */
    (uint8_t)'B', (uint8_t)'L', (uint8_t)'E', (uint8_t)' ', (uint8_t)'G', (uint8_t)'a', (uint8_t)'t', (uint8_t)'e',
(uint8_t)'w', (uint8_t)'a', (uint8_t)'y', (uint8_t)' ', (uint8_t)'1', 
...
static const uint8_t cy_ble_attUuid128[][16u] = {
    /* Device_Interface */
    { 0xA6u, 0xB1u, 0x86u, 0x08u, 0xF9u, 0x7Eu, 0x2Cu, 0x8Fu, 0x0Cu, 0x45u, 0x13u, 0xA9u, 0xEAu, 0x43u, 0xAEu, 0x47u },
    /* GREEN_LED_TOGGLE */
    { 0xFFu, 0xFCu, 0xAEu, 0xE0u, 0xEFu, 0xA0u, 0x46u, 0x8Du, 0xF2u, 0x43u, 0x8Eu, 0xAFu, 0xECu, 0xB1u, 0x61u, 0xDFu },
    /* RED_LED_TOGGLE */
    { 0x89u, 0xC4u, 0xD4u, 0x65u, 0x84u, 0xA4u, 0x72u, 0x96u, 0x46u, 0x40u, 0x85u, 0x6Eu, 0x3Au, 0x3Cu, 0xDEu, 0x55u },
};
...
static cy_stc_ble_gatts_att_gen_val_len_t cy_ble_attValuesLen[0x0Cu] = {
    ...
    { 0x0010u, (void *)&cy_ble_attUuid128[0] }, /* Device_Interface UUID */
    { 0x0010u, (void *)&cy_ble_attUuid128[1] }, /* GREEN_LED_TOGGLE UUID */
    { 0x0001u, (void *)&cy_ble_attValues[29] }, /* GREEN_LED_TOGGLE */
    { 0x0010u, (void *)&cy_ble_attUuid128[2] }, /* RED_LED_TOGGLE UUID */
    { 0x0001u, (void *)&cy_ble_attValues[30] }, /* RED_LED_TOGGLE */
};
...
static const cy_stc_ble_gatts_db_t cy_ble_gattDB[0x14u] = {
    ...
    { 0x0012u, 0xB1ECu /* GREEN_LED_TOGGLE                    */, 0x09080100u /* wr    */, 0x0012u, {{0x0001u, (void *)&cy_ble_attValuesLen[9]}} },
    { 0x0013u, 0x2803u /* Characteristic                      */, 0x00080001u /* wr    */, 0x0014u, {{0x0010u, (void *)&cy_ble_attValuesLen[10]}} },
    { 0x0014u, 0x3C3Au /* RED_LED_TOGGLE                      */, 0x09080100u /* wr    */, 0x0014u, {{0x0001u, (void *)&cy_ble_attValuesLen[11]}} },
};
